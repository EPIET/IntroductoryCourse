---
title: "SimOb Inject 14 - Data import and cleaning"
format: docx
editor: visual
execute: 
  output: false
...
| All the food variables                                                                                      | integer   | logical | mutate(across()), as.logical()                               |
...
| starthour                                                                                                   | integer   |         | paste dayonset and starthour and then use lubridate::ymd_h() |

: Table 1_Inject14: Variable types to modify
...
Save the cleaned data set before proceeding with using your case definition to identify cases in your dataset.
